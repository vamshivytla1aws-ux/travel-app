...
export async function ensureTransportEnhancements() {
  ...
  `);
  await query(`ALTER TABLE driver_profiles ADD COLUMN IF NOT EXISTS blood_group VARCHAR(10);`);
  await query(`ALTER TABLE driver_profiles ADD COLUMN IF NOT EXISTS father_name VARCHAR(120);`);
  await query(`ALTER TABLE driver_profiles ADD COLUMN IF NOT EXISTS father_contact VARCHAR(20);`);
  await query(`ALTER TABLE driver_profiles ADD COLUMN IF NOT EXISTS mother_name VARCHAR(120);`);
  await query(`ALTER TABLE driver_profiles ADD COLUMN IF NOT EXISTS mother_contact VARCHAR(20);`);
  await query(`ALTER TABLE driver_profiles ADD COLUMN IF NOT EXISTS spouse_name VARCHAR(120);`);
  await query(`ALTER TABLE driver_profiles ADD COLUMN IF NOT EXISTS spouse_contact VARCHAR(20);`);
  await query(`ALTER TABLE driver_profiles ADD COLUMN IF NOT EXISTS child_1_name VARCHAR(120);`);
  await query(`ALTER TABLE driver_profiles ADD COLUMN IF NOT EXISTS child_2_name VARCHAR(120);`);
  await query(`ALTER TABLE driver_profiles ADD COLUMN IF NOT EXISTS pan_or_voter_id VARCHAR(40);`);
  await query(`ALTER TABLE driver_profiles ADD COLUMN IF NOT EXISTS aadhaar_no VARCHAR(20);`);
  await query(`ALTER TABLE driver_profiles ADD COLUMN IF NOT EXISTS vehicle_bus_id BIGINT REFERENCES buses(id);`);
  await query(`ALTER TABLE driver_profiles ADD COLUMN IF NOT EXISTS vehicle_registration_no VARCHAR(40);`);
  await query(`ALTER TABLE driver_profiles ADD COLUMN IF NOT EXISTS present_reading_km NUMERIC(12,2);`);
  await query(`ALTER TABLE driver_profiles ADD COLUMN IF NOT EXISTS badge_no VARCHAR(40);`);
  await query(`ALTER TABLE driver_profiles ADD COLUMN IF NOT EXISTS badge_validity DATE;`);
  await query(`ALTER TABLE driver_profiles ADD COLUMN IF NOT EXISTS education VARCHAR(120);`);
  await query(`ALTER TABLE driver_profiles ADD COLUMN IF NOT EXISTS date_of_birth DATE;`);
  await query(`ALTER TABLE driver_profiles ADD COLUMN IF NOT EXISTS marital_status VARCHAR(40);`);
  await query(`ALTER TABLE driver_profiles ADD COLUMN IF NOT EXISTS religion VARCHAR(80);`);
  await query(`ALTER TABLE driver_profiles ADD COLUMN IF NOT EXISTS present_village VARCHAR(120);`);
  await query(`ALTER TABLE driver_profiles ADD COLUMN IF NOT EXISTS present_landmark VARCHAR(180);`);
  await query(`ALTER TABLE driver_profiles ADD COLUMN IF NOT EXISTS present_post_office VARCHAR(120);`);
  await query(`ALTER TABLE driver_profiles ADD COLUMN IF NOT EXISTS present_mandal VARCHAR(120);`);
  await query(`ALTER TABLE driver_profiles ADD COLUMN IF NOT EXISTS present_police_station VARCHAR(120);`);
  await query(`ALTER TABLE driver_profiles ADD COLUMN IF NOT EXISTS present_district VARCHAR(120);`);
  await query(`ALTER TABLE driver_profiles ADD COLUMN IF NOT EXISTS present_state VARCHAR(120);`);
  await query(`ALTER TABLE driver_profiles ADD COLUMN IF NOT EXISTS present_pin_code VARCHAR(20);`);
  await query(`ALTER TABLE driver_profiles ADD COLUMN IF NOT EXISTS permanent_village VARCHAR(120);`);
  await query(`ALTER TABLE driver_profiles ADD COLUMN IF NOT EXISTS permanent_landmark VARCHAR(180);`);
  await query(`ALTER TABLE driver_profiles ADD COLUMN IF NOT EXISTS permanent_post_office VARCHAR(120);`);
  await query(`ALTER TABLE driver_profiles ADD COLUMN IF NOT EXISTS permanent_mandal VARCHAR(120);`);
  await query(`ALTER TABLE driver_profiles ADD COLUMN IF NOT EXISTS permanent_police_station VARCHAR(120);`);
  await query(`ALTER TABLE driver_profiles ADD COLUMN IF NOT EXISTS permanent_district VARCHAR(120);`);
  await query(`ALTER TABLE driver_profiles ADD COLUMN IF NOT EXISTS permanent_state VARCHAR(120);`);
  await query(`ALTER TABLE driver_profiles ADD COLUMN IF NOT EXISTS permanent_pin_code VARCHAR(20);`);
  await query(`ALTER TABLE driver_profiles ADD COLUMN IF NOT EXISTS reference1_name VARCHAR(120);`);
  await query(`ALTER TABLE driver_profiles ADD COLUMN IF NOT EXISTS reference1_relationship VARCHAR(120);`);
  await query(`ALTER TABLE driver_profiles ADD COLUMN IF NOT EXISTS reference1_contact VARCHAR(20);`);
  await query(`ALTER TABLE driver_profiles ADD COLUMN IF NOT EXISTS reference2_name VARCHAR(120);`);
  await query(`ALTER TABLE driver_profiles ADD COLUMN IF NOT EXISTS reference2_relationship VARCHAR(120);`);
  await query(`ALTER TABLE driver_profiles ADD COLUMN IF NOT EXISTS reference2_contact VARCHAR(20);`);
  await query(`ALTER TABLE driver_profiles ADD COLUMN IF NOT EXISTS present_salary NUMERIC(12,2);`);
  await query(`ALTER TABLE driver_profiles ADD COLUMN IF NOT EXISTS salary_expectation NUMERIC(12,2);`);
  await query(`ALTER TABLE driver_profiles ADD COLUMN IF NOT EXISTS salary_offered NUMERIC(12,2);`);
  await query(`ALTER TABLE driver_profiles ADD COLUMN IF NOT EXISTS joining_date DATE;`);
  await query(`ALTER TABLE driver_profiles ADD COLUMN IF NOT EXISTS candidate_signature_text VARCHAR(160);`);
  await query(`ALTER TABLE driver_profiles ADD COLUMN IF NOT EXISTS candidate_signature_date DATE;`);
  await query(`ALTER TABLE driver_profiles ADD COLUMN IF NOT EXISTS appointee_signature_text VARCHAR(160);`);
  await query(`ALTER TABLE driver_profiles ADD COLUMN IF NOT EXISTS approval_authority_signature_text VARCHAR(160);`);
  await query(`ALTER TABLE driver_profiles ADD COLUMN IF NOT EXISTS created_at TIMESTAMPTZ NOT NULL DEFAULT NOW();`);
  await query(`ALTER TABLE driver_profiles ADD COLUMN IF NOT EXISTS updated_at TIMESTAMPTZ NOT NULL DEFAULT NOW();`);
